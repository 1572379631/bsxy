      ...
      <form class="am-form am-form-horizontal">
       <div class="am-g am-margin-top">
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-3" style="float: left">
              <select style="width: 200px;height: 36px;font-size: 14px" name="placeStatus">
          ...
          <div class="am-g am-margin-top">
            ...
            <div class="am-u-sm-8 am-u-md-3" style="float: left">
              <select style="width: 200px;height: 36px;font-size: 14px" name="fla">
					<option value="1">场地表</option>
					<option value="2">场地申请表</option>
			   </select>
            </div>
             <div class="am-u-sm-4 am-u-md-1 am-text-right"></div>
            <div class="am-u-sm-8 am-u-md-3">
				<input style="width: 200px;height: 36px;font-size: 14px" type="hidden">
            </div>
            <div class="am-margin" style="text-align: center; margin-top: 10px;float: right;">
          ...
          <div id="fenye">
       		 <iframe src="${pageContext.request.contextPath}/query/placeUseStatusList" frameborder="0" align="left" width="100%" height="450px" scrolling="no"></iframe>
      	  </div>
    </div>
...
function submitFrom(){
	...
	var fla=  $("select[name='fla']").find("option:selected").val();
	var place_name = $("#place_name").val();
	var placeStatus=  $("select[name='placeStatus']").find("option:selected").val();
	
	$("#fenye").append('<iframe src="${pageContext.request.contextPath}/query/placeUseStatusList?placeDivision='+placeDivision+'&placeLieu='+placeLieu+'&placeName='+place_name+'&fla='+fla+'&placeStatus='+placeStatus+'" frameborder="0" align="left" width="100%" height="450px" scrolling="no"></iframe>');
}
</script>
