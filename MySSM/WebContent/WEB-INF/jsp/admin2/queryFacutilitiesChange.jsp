    ...
    <div class="admin-biaoge">
      ...
      <form class="am-form am-form-horizontal" >
       <div class="am-g am-margin-top">
        ...
        <div id="fenye">
       		<iframe src="${pageContext.request.contextPath}/query/queryFacutilitiesChangeList" frameborder="0" align="left" width="100%" height="500px" scrolling="no"></iframe>
       </div>
...
function deleteFacutilitiesChangeSin(mtId){
	...
	$.ajax({
		type : 'post',
		url : projectName + '/delete/deleteFacutilitiesChangeSin',
		dataType : 'json',
		data : {
			mtId : mtId,
		},
...
function submitFrom(){
	...
	var mtdept = $("#mtdept").val();
	$("#fenye").append('<iframe src="${pageContext.request.contextPath}/query/queryFacutilitiesChangeList?placeDivision='+placeDivision+'&placeLieu='+placeLieu+'&placeName='+place_name+'&mtdept='+mtdept+'" frameborder="0" align="left" width="100%" height="500px" scrolling="no"></iframe>');
